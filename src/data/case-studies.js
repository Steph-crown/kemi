        ...
        timeLines: [
          {
            ...
            list: ["Identify the pain point"],
            iconColor: "#F29D05",
          },
          {
            headerText: "User Experience",
            list: [
              "Pain Point Analysis",
              "Empathy Map",
              "User Persona",
      ...
      workNode: {
        ...
        workNode: {
          ...
          timeLines: [
            ...
            {
              headerText: "Ux Design",
              list: [],
              iconColor: "#5182FF",
            },
            {
              headerText: "Ui Wireframe",
              list: [],
              iconColor: "#FEEB43",
            },
            {
              headerText: "Visual Design",
              list: [],
              iconColor: "#0DA34E",
            },
            {
    ...
    work: {
      ...
      workNode: {
        ...
        timeLines: [
          ...
          {
            headerText: "Ux Research",
            list: [],
            iconColor: "#000000",
            bgColor: "#0DA34E",
          },
          {
            headerText: "Wireframing",
            list: [],
            iconColor: "#5182FF",
            bgColor: "#DBC715",
          },
          {
            headerText: "User Flow",
            list: [],
            iconColor: "#000000",
            bgColor: "#FF5E00",
          },
          {
            ...
            list: [],
            iconColor: "#5182FF",
            bgColor: "rgba(189, 56, 39, 0.8)",
          },
          {
            headerText: "Design System",
            list: [],
            iconColor: "#000000",
            bgColor: "#407BFF",
          },
